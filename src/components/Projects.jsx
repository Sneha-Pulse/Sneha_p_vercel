  ...
  const projects = [
    {
      id: 1,
      image: Blog_App,
      imageAlt: "Food_Ordering_Website",
      name: "Food_Ordering_Website",
      description: "A seamless App to order your favourite dish any day anytime",
      links: {
        gitHub: "https://github.com/Sneha-Pulse/food_Ordering_website",
        hosted: "https://github.com/Sneha-Pulse/food_Ordering_website"
      },
      tags: [
